...
SUBROUTINE mem_allocate()
    ...
    ALLOCATE (stencilElem(1:nbrNodes,1:maxstencil+1))
...
SUBROUTINE mem_deallocate()
    ...
    IF (ALLOCATED(stencilElem)) DEALLOCATE(stencilElem)
    IF (ALLOCATED(rhs)) DEALLOCATE(rhs)
    IF (ALLOCATED(ia)) DEALLOCATE(ia)
    IF (ALLOCATED(ja)) DEALLOCATE(ja)
    IF (ALLOCATED(mat)) DEALLOCATE(mat)

    IF (ALLOCATED(Brr)) DEALLOCATE(Brr)
    IF (ALLOCATED(Bri)) DEALLOCATE(Bri)
    IF (ALLOCATED(Bzr)) DEALLOCATE(Bzr)
    IF (ALLOCATED(Bzi)) DEALLOCATE(Bzi)
    IF (ALLOCATED(Frad)) DEALLOCATE(Frad)
    IF (ALLOCATED(Fax)) DEALLOCATE(Fax)
    IF (ALLOCATED(dissJoule)) DEALLOCATE(dissJoule)
